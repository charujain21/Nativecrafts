...
<img src={assets.bottom_banner_image} alt='banner' className='w-full h-[500px] hidden md:block' />
<img src={assets.bottom_banner_image_sm} alt='banner' className='w-full h-[500px] md:hidden' />
